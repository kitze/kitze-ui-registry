...
export type ComponentName = "theme-switch-slider-next-themes" | "with-search-bar" | "theme-switch-slider" | "ui-alert" | "theme-switch-minimal" | "suspensed" | "theme-switch-minimal-next-themes" | "spinner" | "simple-select" | "simple-tooltip" | "simple-popover" | "tab-panels" | "simple-dialog" | "simple-context-menu" | "search-bar" | "segmented-control" | "simple-dropdown-menu" | "page-header" | "menu-context" | "kitze-ui-context" | "kbd-shortcuts-list" | "kbd-shortcuts" | "input" | "hoverable-icon" | "kbd" | "gradient-text" | "help-info-circle" | "form-field-wrapper" | "form-field-textarea" | "simple-accordion" | "full-page-spinner" | "form-field-select" | "form-field-segmented-control" | "form-field-input" | "fill-height-spinner" | "form-field-advanced-select" | "dialog-manager" | "custom-button" | "form-field-checkbox" | "conditional-tooltip" | "conditional-wrap" | "advanced-select" | "custom-badge" | "bottom-drawer"; // Handle empty case
