...
export type ComponentName = "with-search-bar" | "ui-alert" | "theme-switch-slider" | "theme-switch-minimal" | "tab-panels" | "suspensed" | "spinner" | "simple-tooltip" | "theme-switch-minimal-next-themes" | "theme-switch-slider-next-themes" | "simple-select" | "simple-popover" | "simple-context-menu" | "simple-accordion" | "segmented-control" | "simple-dropdown-menu" | "search-bar" | "page-header" | "menu-context" | "kitze-ui-context" | "kbd-shortcuts-list" | "simple-dialog" | "kbd-shortcuts" | "kbd" | "input" | "help-info-circle" | "full-page-spinner" | "gradient-text" | "form-field-textarea" | "form-field-wrapper" | "form-field-select" | "form-field-checkbox" | "form-field-input" | "form-field-segmented-control" | "form-field-advanced-select" | "form-debug" | "hoverable-icon" | "dialog-manager" | "custom-button" | "fill-height-spinner" | "custom-badge" | "conditional-tooltip" | "conditional-wrap" | "advanced-select" | "bottom-drawer"; // Handle empty case
