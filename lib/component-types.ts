...
export type ComponentName = "with-search-bar" | "ui-alert" | "theme-switch-slider-next-themes" | "theme-switch-slider" | "theme-switch-minimal" | "suspensed" | "tab-panels" | "spinner" | "simple-tooltip" | "simple-popover" | "theme-switch-minimal-next-themes" | "simple-select" | "simple-dialog" | "simple-dropdown-menu" | "simple-accordion" | "segmented-control" | "simple-context-menu" | "search-bar" | "responsive-select-bottom-drawer-menu" | "responsive-dropdown-menu" | "responsive-dialog" | "responsive-context-menu" | "page-header" | "menu-context" | "kitze-ui-context" | "labeled-switch" | "labeled-checkbox" | "kbd-shortcuts-list" | "kbd-shortcuts" | "input" | "kbd" | "hoverable-icon" | "full-page-spinner" | "help-info-circle" | "gradient-text" | "form-field-wrapper" | "form-field-textarea" | "form-field-select" | "form-field-segmented-control" | "form-field-input" | "form-field-checkbox" | "fill-height-spinner" | "form-field-advanced-select" | "form-debug" | "dialog-manager" | "custom-badge" | "conditional-wrap" | "custom-button" | "conditional-tooltip" | "bottom-drawer" | "advanced-select"; // Handle empty case
