...
export type ComponentName = "with-search-bar" | "ui-alert" | "theme-switch-slider" | "theme-switch-minimal-next-themes" | "theme-switch-minimal" | "tab-panels" | "suspensed" | "spinner" | "theme-switch-slider-next-themes" | "simple-tooltip" | "simple-select" | "simple-dialog" | "simple-dropdown-menu" | "simple-popover" | "simple-context-menu" | "simple-accordion" | "search-bar" | "page-header" | "menu-context" | "kitze-ui-context" | "kbd-shortcuts-list" | "segmented-control" | "kbd-shortcuts" | "kbd" | "hoverable-icon" | "input" | "help-info-circle" | "gradient-text" | "full-page-spinner" | "form-field-wrapper" | "form-field-textarea" | "form-field-select" | "form-field-checkbox" | "fill-height-spinner" | "form-field-advanced-select" | "dialog-manager" | "custom-button" | "custom-badge" | "conditional-wrap" | "conditional-tooltip" | "advanced-select" | "form-field-input" | "bottom-drawer"; // Handle empty case
