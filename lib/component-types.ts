...
export type ComponentName = "ui-alert" | "theme-switch-slider" | "theme-switch-slider-next-themes" | "theme-switch-minimal-next-themes" | "theme-switch-minimal" | "tab-panels" | "suspensed" | "with-search-bar" | "spinner" | "simple-tooltip" | "simple-select" | "simple-popover" | "simple-accordion" | "simple-dialog" | "simple-context-menu" | "simple-dropdown-menu" | "segmented-control" | "search-bar" | "scrolling-header" | "responsive-select-bottom-drawer-menu" | "responsive-context-menu" | "responsive-dialog" | "responsive-dropdown-menu" | "polar-checkout-button" | "page-header" | "meta-image" | "menu-context" | "mac-window" | "made-by-kitze" | "labeled-switch" | "labeled-checkbox" | "kitze-ui-context" | "kbd-shortcuts" | "kbd-shortcuts-list" | "kbd" | "hoverable-icon" | "help-info-circle" | "input" | "gradient-text" | "full-page-spinner" | "form-field-select" | "form-field-wrapper" | "form-field-textarea" | "form-field-segmented-control" | "form-field-advanced-select" | "form-field-checkbox" | "form-debug" | "form-field-input" | "footer-column-kitze-apps" | "footer-bottom" | "footer-column-connect" | "fill-height-spinner" | "custom-button" | "dialog-manager" | "custom-badge" | "conditional-wrap" | "conditional-tooltip" | "apple-logo" | "bottom-drawer" | "advanced-select"; // Handle empty case
...
export const componentMeta: Record<ComponentName, ComponentMeta> = {
  ...
  "scrolling-header": {
    ...
    description: "A sticky header component that appears after scrolling past a threshold, with smooth animations"
  },
  "responsive-select-bottom-drawer-menu": {
    name: "responsive-select-bottom-drawer-menu",
    title: "Responsive Select Bottom Drawer Menu",
    description: "A responsive select menu displayed in a bottom drawer, with search functionality."
  },
  ...
  "responsive-dialog": {
    ...
    description: "A responsive dialog component that adapts to mobile devices with bottom drawer fallback"
  },
  "responsive-dropdown-menu": {
    name: "responsive-dropdown-menu",
    title: "Responsive Dropdown Menu",
    description: "A responsive dropdown menu component that adapts to mobile devices with bottom drawer fallback"
  },
  "polar-checkout-button": {
    name: "polar-checkout-button",
    title: "Polar Checkout Button",
    description: "A checkout button component for Polar/payment redirects with loading state, Apple logo, and multiple variants"
  },
  "page-header": {
    name: "page-header",
    title: "Page Header",
  ...
  "meta-image": {
    name: "meta-image",
    title: "Meta Image",
    description: "A reusable component for generating OpenGraph/Twitter meta images at 1200x630 dimensions"
  },
  "menu-context": {
    name: "menu-context",
    title: "Menu Context",
  ...
  "made-by-kitze": {
    name: "made-by-kitze",
    title: "Made By Kitze",
    description: "A section component showcasing apps made by Kitze with animated cards and social links"
  },
  "labeled-switch": {
    name: "labeled-switch",
  ...
  "form-debug": {
    name: "form-debug",
    title: "Form Debug",
    description: "A component to display react-hook-form state for debugging purposes."
  },
  "form-field-input": {
