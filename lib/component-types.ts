...
export type ComponentName = "with-search-bar" | "ui-alert" | "theme-switch-slider" | "theme-switch-slider-next-themes" | "theme-switch-minimal-next-themes" | "theme-switch-minimal" | "suspensed" | "spinner" | "tab-panels" | "simple-tooltip" | "simple-select" | "simple-popover" | "simple-dropdown-menu" | "simple-context-menu" | "simple-dialog" | "simple-accordion" | "search-bar" | "segmented-control" | "responsive-select-bottom-drawer-menu" | "page-header" | "menu-context" | "kitze-ui-context" | "kbd-shortcuts-list" | "kbd-shortcuts" | "kbd" | "input" | "help-info-circle" | "hoverable-icon" | "gradient-text" | "full-page-spinner" | "form-field-wrapper" | "form-field-textarea" | "form-field-select" | "form-field-input" | "form-field-segmented-control" | "form-field-checkbox" | "form-field-advanced-select" | "form-debug" | "fill-height-spinner" | "dialog-manager" | "custom-button" | "custom-badge" | "conditional-wrap" | "conditional-tooltip" | "bottom-drawer" | "advanced-select"; // Handle empty case
