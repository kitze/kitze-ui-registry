...
export type ComponentName = "theme-switch-slider-next-themes" | "ui-alert" | "with-search-bar" | "theme-switch-slider" | "theme-switch-minimal-next-themes" | "theme-switch-minimal" | "suspensed" | "tab-panels" | "simple-tooltip" | "spinner" | "simple-select" | "simple-popover" | "simple-dialog" | "simple-context-menu" | "simple-dropdown-menu" | "search-bar" | "segmented-control" | "simple-accordion" | "menu-context" | "page-header" | "kitze-ui-context" | "kbd-shortcuts-list" | "kbd-shortcuts" | "kbd" | "input" | "gradient-text" | "help-info-circle" | "hoverable-icon" | "full-page-spinner" | "form-field-select" | "form-field-textarea" | "form-field-wrapper" | "form-field-input" | "form-field-segmented-control" | "form-field-checkbox" | "form-field-advanced-select" | "fill-height-spinner" | "dialog-manager" | "custom-button" | "custom-badge" | "conditional-wrap" | "conditional-tooltip" | "advanced-select" | "bottom-drawer"; // Handle empty case
