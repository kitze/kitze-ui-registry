...
export type ComponentName = "ui-alert" | "theme-switch-slider-next-themes" | "theme-switch-slider" | "theme-switch-minimal-next-themes" | "theme-switch-minimal" | "spinner" | "simple-tooltip" | "simple-popover" | "simple-dropdown-menu" | "simple-dialog" | "simple-context-menu" | "simple-accordion" | "responsive-popover" | "responsive-dialog" | "responsive-tooltip" | "menu-context" | "help-info-circle" | "full-page-spinner" | "suspensed" | "kitze-ui-context" | "form-field-wrapper" | "form-field-checkbox" | "fill-height-spinner" | "form-field-input" | "custom-button" | "conditional-tooltip" | "bottom-drawer" | "conditional-wrap" | "page-header";
