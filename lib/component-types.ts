...
export type ComponentName = "with-search-bar" | "theme-switch-slider-next-themes" | "ui-alert" | "theme-switch-minimal" | "theme-switch-slider" | "suspensed" | "spinner" | "tab-panels" | "simple-tooltip" | "simple-select" | "theme-switch-minimal-next-themes" | "simple-dropdown-menu" | "simple-dialog" | "simple-accordion" | "simple-popover" | "responsive-select-bottom-drawer-menu" | "segmented-control" | "page-header" | "search-bar" | "menu-context" | "kitze-ui-context" | "kbd-shortcuts-list" | "input" | "kbd" | "kbd-shortcuts" | "hoverable-icon" | "full-page-spinner" | "gradient-text" | "help-info-circle" | "form-field-wrapper" | "form-field-select" | "form-field-textarea" | "simple-context-menu" | "form-field-segmented-control" | "form-debug" | "form-field-advanced-select" | "form-field-input" | "fill-height-spinner" | "dialog-manager" | "form-field-checkbox" | "custom-badge" | "custom-button" | "conditional-wrap" | "conditional-tooltip" | "bottom-drawer" | "advanced-select"; // Handle empty case
