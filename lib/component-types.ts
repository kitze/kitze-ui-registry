...
export type ComponentName = "theme-switch-slider-next-themes" | "theme-switch-slider" | "theme-switch-minimal-next-themes" | "theme-switch-minimal" | "suspensed" | "spinner" | "simple-accordion" | "simple-tooltip" | "page-header" | "full-page-spinner" | "fill-height-spinner" | "custom-button" | "conditional-tooltip" | "conditional-wrap" | "kitze-ui-context" | "bottom-drawer";
