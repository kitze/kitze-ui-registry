...
export type ComponentName = "with-search-bar" | "ui-alert" | "theme-switch-minimal-next-themes" | "theme-switch-slider-next-themes" | "theme-switch-slider" | "theme-switch-minimal" | "suspensed" | "spinner" | "tab-panels" | "simple-tooltip" | "simple-select" | "simple-popover" | "simple-context-menu" | "simple-accordion" | "segmented-control" | "simple-dropdown-menu" | "search-bar" | "page-header" | "menu-context" | "kitze-ui-context" | "kbd-shortcuts-list" | "kbd" | "kbd-shortcuts" | "simple-dialog" | "input" | "hoverable-icon" | "gradient-text" | "full-page-spinner" | "form-field-wrapper" | "form-field-textarea" | "form-field-checkbox" | "form-field-input" | "form-field-advanced-select" | "fill-height-spinner" | "dialog-manager" | "custom-button" | "conditional-wrap" | "conditional-tooltip" | "bottom-drawer" | "advanced-select" | "help-info-circle" | "form-field-select"; // Handle empty case
